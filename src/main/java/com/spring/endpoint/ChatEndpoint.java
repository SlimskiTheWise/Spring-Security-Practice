...
//	List<Object> principal = Collections.synchronizedList((List<Object>) SecurityContextHolder.getContext().getAuthentication().getPrincipal()); 
//	
...
//		
//		this.session = (HttpSession)config.getUserProperties();
//	}
//	
//	@OnMessage
